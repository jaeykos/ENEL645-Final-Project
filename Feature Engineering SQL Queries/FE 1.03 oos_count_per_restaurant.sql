-- This query shows the total OOS count over different time periods (that have the same restauraunt id as the current row)
CREATE OR REPLACE TABLE `just-data-sandbox-oos.feature_engineering.FE103` AS
SELECT
  *,
  ...
  ) AS oss_count_past_1_hour_per_restaurant,
  ...
  (
    ...
    WHERE
      ...
      AND t2.scenario = 'OUT_OF_STOCK'
      AND t2.unique_id != t1.unique_id
  ) AS oss_count_past_3_hours_per_restaurant,
  ...
  (
    ...
    WHERE
      ...
      AND t2.scenario = 'OUT_OF_STOCK'
      AND t2.unique_id != t1.unique_id
  ) AS oss_count_past_6_hours_per_restaurant,
  ...
  (
    ...
    WHERE
      ...
      AND t2.scenario = 'OUT_OF_STOCK'
      AND t2.unique_id != t1.unique_id
  ) AS oss_count_past_1_day_per_restaurant,
  ...
  (
    ...
    WHERE
      ...
      AND t2.scenario = 'OUT_OF_STOCK'
      AND t2.unique_id != t1.unique_id
  ) AS oss_count_today_per_restaurant,
  ...
  (
    ...
    WHERE
      ...
      AND t2.scenario = 'OUT_OF_STOCK'
      AND t2.unique_id != t1.unique_id
  ) AS oss_count_past_3_days_per_restaurant,
  ...
  (
    ...
    WHERE
      ...
      AND t2.scenario = 'OUT_OF_STOCK'
      AND t2.unique_id != t1.unique_id
  ) AS oss_count_past_1_week_per_restaurant,
  ...
  (
    ...
    WHERE
      ...
      AND t2.scenario = 'OUT_OF_STOCK'
      AND t2.unique_id != t1.unique_id
  ) AS oss_count_past_1_month_per_restaurant,
