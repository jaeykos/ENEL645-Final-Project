CREATE OR REPLACE TABLE `just-data-sandbox-oos.feature_engineering.FE313` AS
WITH loss_data AS (
    SELECT
        unique_id,
        order_item_name,
...
aggregated_loss AS (
    ...
    ON l.order_item_name = d.order_item_name
    AND d.createdTime < l.createdTime

    GROUP BY l.unique_id, l.order_item_name, l.createdTime, l.scenario
)
